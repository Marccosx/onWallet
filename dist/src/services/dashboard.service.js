...
export class DashboardService {
    async getSumary(data) {
        ...
        const Dashboard = { currentAmount, monthExpense, monthRecipe, ExpensePerCategory: ExpensePerCategory ?? [] };
        return Dashboard;
    }
    async getAmountAccountsByMonth() {
        try {
    ...
    async getIncomesTransactions(data) {
        if (!data) {
    ...
    async getExpenseTransactions(data) {
        if (!data) {
    ...
    async getExpenseTransactionsPerCategory(data) {
        if (!data) {
            throw new Error("Error, data is missing for get expense transactions");
        }
        const date = this.getDate(data);
